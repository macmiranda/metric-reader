...
func TestStateTransition_NotBreached_To_SoftActive(t *testing.T) {
	...
	processThresholdStateMachine(state, thresholdCfg, 90.0, 5*time.Second, 0, 5*time.Second, 0, "test_query")
...
func TestStateTransition_SoftActive_To_NotBreached(t *testing.T) {
	...
	processThresholdStateMachine(state, thresholdCfg, 70.0, 5*time.Second, 0, 5*time.Second, 0, "test_query")
...
func TestStateTransition_SoftActive_To_HardActive(t *testing.T) {
	...
	processThresholdStateMachine(state, thresholdCfg, 110.0, 5*time.Second, 0, 5*time.Second, 0, "test_query")
...
func TestBackoffPeriod_SoftThreshold(t *testing.T) {
	...
	processThresholdStateMachine(state, thresholdCfg, 90.0, 0, 0, 0, 0, "test_query")
...
func TestBackoffPeriod_Expiry(t *testing.T) {
	...
	processThresholdStateMachine(state, thresholdCfg, 90.0, 5*time.Second, 10*time.Second, 5*time.Second, 10*time.Second, "test_query")
...
func TestLessThanOperator(t *testing.T) {
	...
	processThresholdStateMachine(state, thresholdCfg, 10.0, 5*time.Second, 0, 5*time.Second, 0, "test_query")
